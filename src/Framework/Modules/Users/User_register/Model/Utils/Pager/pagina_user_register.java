...
public class pagina_user_register {
    ...
    public static void inicializa() {
        ...
        rowCount = ((miniSimpleTableModel_user_register) pager_user_register.TABLA.getModel()).getRowCount();
    ...
    public static void initLinkBox() {
        ...
        if ((rowCount <= itemsPerPage) && (rowCount
            ...
            pager_user_register.primero.setEnabled(false);
            pager_user_register.ANTERIOR.setEnabled(false);
            pager_user_register.SIGUIENTE.setEnabled(false);
            pager_user_register.ultimo.setEnabled(false);
            pager_user_register.CAJA.setText("");
            ...
            pager_user_register.primero.setEnabled(currentPageIndex > 1);
            pager_user_register.ANTERIOR.setEnabled(currentPageIndex > 1);
            pager_user_register.SIGUIENTE.setEnabled(currentPageIndex < maxPageIndex);
            pager_user_register.ultimo.setEnabled(currentPageIndex < maxPageIndex);
            pager_user_register.CAJA.setText(Integer.toString(currentPageIndex) + String.format(" / %d", maxPageIndex));
