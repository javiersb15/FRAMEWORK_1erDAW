...
public class Core_users {
	...
	return insertname;
        ...
        /**INSERT SURNAME*/
	public static String insertsurname(String message, String title){
		String insertsurname=" ";
		boolean validate=false;
		
		do{
			insertsurname=Functions.givestring(message, title);
			validate=Validate.validate_surname(insertsurname);
			if(validate==false)
				JOptionPane.showMessageDialog(null, "You must enter only letters","Error"
						,JOptionPane.INFORMATION_MESSAGE);
		}while (validate==false);
	...
	public static String insertemail(String message, String title) {
        ...
        /**INSERT USER*/
	public static String insertuser(String message, String title) {
		String insertuser=" ";
		boolean validate=false;
		
		do {
			insertuser=Functions.givestring(message, title);
			validate=Validate.validate_user(insertuser);
			if (validate==false)
				JOptionPane.showMessageDialog(null, "You must enter the user correctly", "Error",
						JOptionPane.INFORMATION_MESSAGE);
		} while (validate==false);
