package Framework.Modules.Users.Client.Model.Utils.Pager;
...
public class pagina {
    ...
    public static void inicializa() {
        ...
        rowCount = ((miniSimpleTableModel_client) pager_client.TABLA.getModel()).getRowCount();
        ...
        pager_client.jPanel4.setLayout(new BorderLayout());
        pager_client.jPanel4.add(pagina.box);

    }

    public static void initLinkBox() {

        pager_client.sorter.setRowFilter(new RowFilter<TableModel, Integer>() {
            @Override
        ...
        if ((rowCount <= itemsPerPage) && (rowCount
            ...
            pager_client.primero.setEnabled(false);
            pager_client.ANTERIOR.setEnabled(false);
            pager_client.SIGUIENTE.setEnabled(false);
            pager_client.ultimo.setEnabled(false);
            pager_client.CAJA.setText("");
            ...
            pager_client.primero.setEnabled(currentPageIndex > 1);
            pager_client.ANTERIOR.setEnabled(currentPageIndex > 1);
            pager_client.SIGUIENTE.setEnabled(currentPageIndex < maxPageIndex);
            pager_client.ultimo.setEnabled(currentPageIndex < maxPageIndex);
            pager_client.CAJA.setText(Integer.toString(currentPageIndex) + String.format(" / %d", maxPageIndex));
