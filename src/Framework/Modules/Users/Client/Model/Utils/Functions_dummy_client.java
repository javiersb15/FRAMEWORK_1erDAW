...
public class Functions_dummy_client{
	...
	private static Class_date date_birthday_cli[]={new Class_date("15/04/1993"),new Class_date("20/05/1987"),new Class_date("12/07/1963"),new Class_date("28/07/1941"),new Class_date("02/12/1973"),new Class_date("28/12/1974")};
	...
	private static Class_date date_start_cli[]={new Class_date("30/08/2015"),new Class_date("18/10/2015"),new Class_date("11/07/2015"),new Class_date("22/06/2015"),new Class_date("11/08/2015"),new Class_date("24/11/2012")};
